...
VirusTotal API 3 версии следует принципам REST и имеет предсказуемые, ориентированные на ресурсы URL-адреса. В этой версии API запросов и ответов (в том числе и ответов с информацией об ошибках) используется JSON.
***
<span style="color:red">some **Важное замечание** text</span>
...
<a name="public_API_vs_premium_API">
...
***
<span style="color:red">**Ограничения публичного API**</span>
...
***
***
<span style="color:blue">**Основные моменты Premium API**</span>
